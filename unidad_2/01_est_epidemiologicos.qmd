...
# Datos
tibble(
  Poblacionales = c("Análisis de situación", "Estudios Ecológicos", ""),
  Individuales = c(
    "Serie de casos",
    "Reporte de casos",
  ...
  kbl_format() |>
  add_header_above(
    c("Estudios descriptivos" = 2, "Estudios analíticos" = 2),
    background = "#2f2e4e",
    color = "white"
  )
```
...
# Datos
tibble(
  Grado = c("1.A", "1.B", "1.C", "2.A", "2.B", "2.C"),

  "Recomendación" = c(rep("Fuerte", 3), rep("Débil", 3)),

  Calidad = rep(c("Alta", "Moderada", "Baja o muy baja"), 2),
