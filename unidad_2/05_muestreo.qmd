...
# Datos
tibble(
  " " = c("Tamaño total", "Número de conglomerados"),
  "Población" = c(966, 21),
  "Muestra" = c(120, 10)
) |>
  # Tabla
...
tibble(
  ...
  "Ponderación" = c(8.4, 4.9, 11.2, 7.53, 6.48, 15.05, 6.48, 9.8, 8.4, 5.78)
) |>
