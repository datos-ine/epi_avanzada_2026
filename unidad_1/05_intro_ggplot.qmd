...
> Se recomienda trabajar con paletas de colores accesibles para personas con daltonismo y otras dificultades en la percepción visual, como las incluidas en las dependencias `RColorBrewer` \[\@RColorBrewer\] y `viridisLite`, así como en paquetes específicos con paletas *colorblind-friendly*, como `scico` \[\@scico\] y `cols4all` \[\@cols4all\].
